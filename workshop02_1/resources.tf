...
output codeserver_zone_name_servers {
  value = data.cloudflare_zone.chuklee.name_servers
}
output codeserver_zone_name_status {
  value = data.cloudflare_zone.chuklee.status
}
